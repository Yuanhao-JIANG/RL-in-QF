\documentclass[balance,upint,subscriptcorrection,varvw,mathalfa=cal=boondoxo,pdf-a,nofoot]{asmeconf}
\usepackage{tikz}
...
\begin{figure*}
    \centering\includegraphics[scale=0.7]{a2c_out}
...
\begin{figure*}
    \centering\includegraphics[scale=0.7]{out}
